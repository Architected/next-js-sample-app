...
Back in the Architected management portal with your application selected ensure that the selected environment is 'Development' as per the screenshot below:
...
The private settings in env.local should now look something like this:
...
Once you have successfully created and verified a user you can now attempt sign-in using the IAM service.
...
This will verify that you are able to upload a file for the user using the file service.
